...
st.markdown("<p style='color:#8892b0;'>اسأل اي سؤال عن البيانات</p>", unsafe_allow_html=True)
...
def try_generate_chart(question, dataframe):
    ...
    if chart_type == "bar":
        ...
        return None
    fig.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(15,17,23,0.8)", font=dict(family="Cairo", color="#ccd6f6"), title_font_size=16, margin=dict(l=20, r=20, t=50, b=20))
    return fig
...
st.markdown("<p style='color:#4a5568; text-align:center; font-size:0.8rem;'>Powered by Gemini 2.0 Flash Lite | Supply Chain Intelligence</p>", unsafe_allow_html=True)
